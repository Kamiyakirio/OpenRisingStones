/** Page-level composition for the glamour workspace. */
import { AppHeader } from "@/shared/components/AppHeader";
import { DiscoveryFilters } from "@/features/glamour/components/DiscoveryFilters";
import { EquipmentSearchPage } from "@/features/equipment/components/EquipmentSearchPage";
...
import { WikiVerificationStatus } from "@/features/wiki/components/WikiVerificationStatus";
import type { LoginProfile } from "@/features/auth/model/auth";
import { useGlamourWorkspaceViewModel } from "@/features/glamour/hooks/useGlamourWorkspaceViewModel";

type GlamourWorkspacePageProps = {
  dark: boolean;
  loginOpen: boolean;
...
export function GlamourWorkspacePage({
  dark,
  loginOpen,
  loginChecking,
  loginExpired,
