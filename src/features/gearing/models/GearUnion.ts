/* eslint-disable @typescript-eslint/no-explicit-any -- Custom MST union references require a recursive runtime boundary. */
/** Retain upstream item/reference resolution semantics. */
...
export const GearUnionReference = mst.types.maybe(
  mst.types.reference(GearUnion, {
    get(identifier, parent): any {
      const value = parent
        ? mst.resolveIdentifier(
            GearUnion as any /* FIXME */,
            parent,
            identifier,
          )
        : undefined;
